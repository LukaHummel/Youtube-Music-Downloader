...
- Editable Telegram progress cards with inline cancel, retry, and source-link buttons
...
throttled to avoid chat spam, while phase changes are shown immediately.
